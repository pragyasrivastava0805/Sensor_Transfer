...
class EuroSAT(Dataset):
    ...
    def __init__(self, root, mode, batchsz, n_way, k_shot, k_query, resize, startidx=0):
        ...
        self.path = os.path.join(root, 'images')  # imagie path
        ...
        for i, (k, v) in enumerate(csvdata.items()):
            ...
            for i in v:
                self.img2label[i] = k  # {"img_name[:9]":label}
...
if __name__ == '__main__':
    ...
    tb = SummaryWriter('runs', 'EuroSAT')
    euro = EuroSAT('/voyager-volume/MAML-Pytorch/EuroSAT/', mode='train', n_way=5, k_shot=1, k_query=1, batchsz=1000, resize=168, startidx=0)

    for i, set_ in enumerate(euro):
